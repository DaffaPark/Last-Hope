  ...
  <body>
    <div class="drawer drawer-mobile">
      ...
      <div class="drawer-side">
        ...
        <div class="overflow-y-auto flex lg:justify-start w-fit">
          <!-- Sidebar content here -->
          <div class="w-fit p-3 lg:m-6 bg-base-100">
          <div class="avatar w-60">
              <div class="w-16 lg:w-32 rounded-full mx-auto">
                <img src="{{ asset('public/assets/img/DORCELE.png') }}" />
              </div>
            </div>
            <!-- avatar end -->
            <h1 class="text-2xl p-2 pl-4">Last Hope Blog</h1>
            <p class="text-sm pl-4">The last of all hope</p>
            @if (Auth::check())
                        <p class="text-sm pl-4 mt-2">Welcome, {{ Auth::user()->name }}</p>
            ...
            <div class="flex gap-1 justify-center pt-4">
              ...
              <a href="https://github.com/DaffaPark" 
              class="btn btn-sm btn-ghost btn-square"
            >
