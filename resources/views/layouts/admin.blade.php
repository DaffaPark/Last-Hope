...
<html :class="{ 'theme-dark': dark }" x-data="data()" lang="en">
  ...
  <body>
    <div
      ...
      <!-- Desktop sidebar -->
      <aside class="bg-gray-50 z-20 hidden w-64 overflow-y-auto bg-white dark:bg-gray-800 md:block flex-shrink-0">
          ...
          <ul class="mt-6">
            ...
            <li class="relative px-6 py-3">
              ...
              <a
                ...
                <span class="ml-4">Blog Page</span>
              </a>
            </li>
          </ul>  
          <ul>
          @can('user-list')
            ...
            <li class="relative px-6 py-3">
              <a
                ...
                <span class="ml-4">Roles Management</span>
              </a>
            </li>
            @endcan
            @can('kategori-list')
            ...
            <li class="relative px-6 py-3">
              <a
                ...
                <span class="ml-4">Posts Management</span>
              </a>
            </li>
            @endcan
          </ul>
            ...
            <ul class="flex items-center flex-shrink-0 space-x-6">
              ...
              <li class="relative">
                ...
                @if($user->photo)
                            ...
                            @else
                                <img src="{{ asset('img/profile.png') }}" class="object-cover w-8 h-8 rounded-full">
                            @endif
                ...
                <template x-if="isProfileMenuOpen">
                  ...
                  >
                    ...
                    <li class="flex">
                    <a class="inline-flex items-center w-full px-2 py-1 text-sm font-semibold transition-colors duration-150 rounded-md hover:bg-gray-100 hover:text-gray-800 dark:hover:bg-gray-800 dark:hover:text-gray-200" href="{{ route('logout') }}" method="POST" action="{{ route('logout') }}"
