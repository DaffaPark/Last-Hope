...
@endif
    ...
    <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
              ...
              <label class="block mt-4 text-sm">
                ...
                <textarea id="summernote" class="form-control block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" style="height:150px" name="desc" placeholder="desc"></textarea>
              </label>
              <label class="block mt-4 text-sm">
              ...
              <label class="block mt-4 text-sm">
                ...
                <input type="text" name="meta_descs" class="form-control block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="meta_descs">
              </label>
              <label class="block mt-4 text-sm">
              ...
              <label class="block mt-4 text-sm">
                ...
                <input type="checkbox" name="navbar_status" class=" text-purple-600 form-radio focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray" placeholder="navbar_status">
              </label>
              <label class="block mt-4 text-sm">
