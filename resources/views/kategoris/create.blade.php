...
@endif
    ...
    <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md 00">
              ...
              <label class="block mt-4 text-sm">
                ...
                <textarea id="summernote" class="form-control block w-full mt-1 text-sm  focus:border-purple-400 focus:outline-none focus:shadow-outline-purple form-input" style="height:150px" name="desc" placeholder="desc"></textarea>
              </label>
              <label class="block mt-4 text-sm">
                <span class="text-gray-700">Image</span>
                <input type="file" name="image" class="form-control block w-full mt-1 text-sm  focus:border-purple-400 focus:outline-none focus:shadow-outline-purple form-input" placeholder="image">
              </label>
              ...
              <label class="block mt-4 text-sm">
                ...
                <input type="text" name="meta_descs" class="form-control block w-full mt-1 text-sm  focus:border-purple-400 focus:outline-none focus:shadow-outline-purple form-input" placeholder="meta_descs">
              </label>
              <label class="block mt-4 text-sm">
              ...
              <label class="block mt-4 text-sm">
                ...
                <input type="checkbox" name="navbar_status" class=" text-purple-600 form-radio focus:border-purple-400 focus:outline-none focus:shadow-outline-purple" placeholder="navbar_status">
              </label>
              <label class="block mt-4 text-sm">
                <span class="text-gray-700">Status</span>
                <input type="checkbox" name="status" class=" text-purple-600 form-radio focus:border-purple-400 focus:outline-none focus:shadow-outline-purple" placeholder="status">
              </label>
