...
@section('meta_descriptions', "$category->meta_descs")
...
<div class="flex-1 p-3 md:py-[35]">
            <div class="space-y-2 md:space-y-6">
              <div class="card bg-base-200 shadow-xl">
                <div class="card-body">
                  <h1 class="md:text-3xl font-extrabold">{{ $category->name }}</h1>
                </div>
              </div>
              <div class="card bg-base-200 shadow-xl">
                <div class="card-body">
                  ...
                  <div class="card card-side bg-base-200 shadow-xl">
                        <div class="card-body">
                         <a href="{{ url('category/'.$category->slug.'/'.$postitem->slug) }}" class="font-bold text-3xl mb-4"> {!! $postitem->name !!}</a>
                          <div class="justify-start mb-2">
                            <p class="btn btn-xs btn-accent">{!! $category->name !!} </p>
                          </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0A17.933 17.933 0 0112 21.75c-2.676 0-5.216-.584-7.499-1.632z" />
                      ...
                      <div class="card card-side bg-base-200 shadow-xl">
                        <div class="card-body">
                          ...
                          <p>
                            There's No Posts Of This Category Yet.
                          </p>
                        </div>
                      </div>
                      @endforelse
